...
variable "initiative" {
  ...
  default     = "terraform-azure-josvega"
}
...
variable vnet_name {
  ...
  default     = "terraform-scripting-azure-josvega"
}
...
variable subnet_1_vm_1 {
  description = "vm name"
  default     = "AZR-SANDBOX-josvega-01"
}

variable subnet_1_vm_2 {
  description = "vm name"
  default     = "AZR-SANDBOX-josvega-02"
}
